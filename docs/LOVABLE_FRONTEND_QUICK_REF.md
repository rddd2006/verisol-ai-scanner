# VeriSol AI — Lovable Frontend Quick Reference
...
- [ ] Hook copied to `src/hooks/useVeriSolScan.js`
- [ ] App component created
- [ ] Test scan with example code
- [ ] Style cards + badges
- [ ] Add result visualization (FindingCard, etc.)
...
| Issue | Fix |
|-------|-----|
| CORS blocked | Check backend has `https://*.lovable.app` in origins |
