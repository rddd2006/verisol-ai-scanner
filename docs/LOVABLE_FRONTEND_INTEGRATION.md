# VeriSol AI — Lovable Frontend Integration Guide

Complete documentation for building a Lovable frontend compatible with the VeriSol backend.
...
| **Current Frontend (Vite)** | `http://localhost:5173` | Development frontend |
| **Lovable Preview** | `https://*.lovable.app` | Any Lovable preview domain |
| **Lovable Production** | `https://yourapp.lovable.app` | Your deployed app |
