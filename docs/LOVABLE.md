# Reproducing VeriSol AI Frontend in Lovable

This guide gives you everything needed to rebuild the frontend in Lovable
and connect it to the VeriSol AI backend.
...
> Lovable cannot use the Vite proxy, so always use the **full URL** including port.

---

## CORS — update before connecting Lovable
...
// After (allow both dev and Lovable preview)
app.use(cors({
  origin: [
    "http://localhost:5173",
    "https://*.lovable.app",  // Lovable preview domain
...
## API Endpoints to implement in Lovable
...
## Complete SSE Hook (copy-paste into Lovable)
